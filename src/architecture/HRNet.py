...
class HighResolutionNet(nn.Module):
    def __init__(self, version_number):
        ...
        num_channels = self.cfg[0]["NUM_CHANNELS"][0]
        ...
        num_channels = self.cfg[1]["NUM_CHANNELS"]
        ...
        self.stage2, pre_stage_channels = self._make_stage(self.cfg[1], num_channels)

        # self.stage3_cfg = extra['STAGE3']
        num_channels = self.cfg[2]["NUM_CHANNELS"]
        block = blocks_dict["BASIC"]
        num_channels = [
            num_channels[i] * block.expansion for i in range(len(num_channels))
        ]
        self.transition2 = self._make_transition_layer(pre_stage_channels, num_channels)
        self.stage3, pre_stage_channels = self._make_stage(self.cfg[2], num_channels)

        # self.stage4_cfg = extra['STAGE4']
        num_channels = self.cfg[3]["NUM_CHANNELS"]
        block = blocks_dict["BASIC"]
        num_channels = [
            num_channels[i] * block.expansion for i in range(len(num_channels))
        ]
        ...
        self.stage4, pre_stage_channels = self._make_stage(
            self.cfg[3], num_channels, multi_scale_output=True
        )
